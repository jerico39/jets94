...
?>
<ul class="c-snsbtn c-snsbtn--black">
  <li>
  ...
  <li>
    <a href="http://twitter.com/intent/tweet?url=<?php echo $url_encode ?>&text=<?php echo $tw_title_encode ?>" target="_blank"><i class="fab fab fa-twitter-square fa-2x"></i> </a>
  </li>
  <li>
  ...
  <li>
    <a href="http://getpocket.com/edit?url=<?php echo $url_encode;?>"target="_blank" class=""><i class="fab fa-get-pocket fa-2x"></i></a>
  </li>
</ul>
